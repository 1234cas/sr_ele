<template>
  <div class="product-container">
    <div class="cInnerContent">
      <!-- <h2 class="header-section gs_reveal ipsType_center">Scroll down and up to see different reveal animations</h2> -->
      <div class="features">
...
export default {
  ...
  activated() {
    ...
    this.go1()
    // reload加inject确实可以刷新 但是放这使用会卡住 并且刷新不了gsap的pin-spacer 只能实现局部刷新
    // this.reload()
  },
  methods: {
    go1() {
